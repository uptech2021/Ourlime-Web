...
// import { Heart, MessageCircle, X, Star, Shield, Clock, Package, Truck, ArrowLeft, ArrowRight } from 'lucide-react';
...
//                 try {
//                     setIsLoading(true);
//                     const [subImagesSnapshot, colorVariantsSnapshot, sizeVariantsSnapshot, variantsSnapshot] = 
//                         await Promise.all([
//                             getDocs(query(collection(db, 'subImages'), 
//                                 where('productId', '==', product.id))),
//                             getDocs(query(collection(db, 'colorVariants'), 
//                                 where('productId', '==', product.id))),
//                             getDocs(query(collection(db, 'sizeVariants'), 
//                                 where('productId', '==', product.id))),
//                             getDocs(query(collection(db, 'variants'), 
//                                 where('productId', '==', product.id)))
//                         ]);
...
//                     setSubImages([product.thumbnailImage, ...images]);
//                     setColorVariants(colorVariantsData);
//                     setSizeVariants(sizeVariantsData);
//                     setVariants(variantsData);

//                     if (colorVariantsData.length > 0) setSelectedColor(colorVariantsData[0].id);
//                     if (sizeVariantsData.length > 0) setSelectedSize(sizeVariantsData[0].id);
...
//                         <div className="w-8 h-8 border-4 border-greenTheme border-t-transparent rounded-full animate-spin" />
//                     </div>
//                 ) : (
//                     <>
//                         {/* Header */}
