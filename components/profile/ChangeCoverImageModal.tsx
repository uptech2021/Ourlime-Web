            ...
            <div className="relative bg-white w-full max-w-2xl m-auto rounded-lg shadow-xl">
                ...
                <div className="flex border-b">
                    <button
                        ...
                        className={`flex-1 px-4 py-3 font-medium ${activeTab === 'existing' ? 'text-greenTheme border-b-2 border-greenTheme' : 'text-gray-600'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex-1 px-4 py-3 font-medium ${activeTab === 'upload' ? 'text-greenTheme border-b-2 border-greenTheme' : 'text-gray-600'
                            }`}
                    >
                        <div className="flex items-center justify-center gap-2">
                            <Upload size={20} />
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {existingImages.map((image) => (
                                <div
                                    ...
                                    className="aspect-video rounded-lg overflow-hidden cursor-pointer hover:ring-2 ring-greenTheme transition-all"
                                >
                                    <Image
                                        src={image.imageURL}
                                        alt="Cover option"
                        ...
                        <div className="text-center p-8">
                            <input
                                ...
                                onChange={(e) => {
                                    handleFileSelect(e);
                                    if (e.target.files?.[0]) {
                                        onUploadNewImage(e.target.files[0]);
                                    }
                                }}
                            />
                            <label
                            ...
                            >
                                {previewImage ? (
                                    <div className="w-full aspect-video rounded-lg overflow-hidden border-4 border-white shadow-md">
                                        <Image
                                            src={previewImage}
                                            alt="Preview"
                                            width={400}
                                ...
                                <span className="text-sm font-medium text-gray-600">
                                    {previewImage ? 'Change photo' : 'Click to upload a new cover photo'}
                                </span>
                ...
                <div className="flex justify-end gap-2 p-4 border-t">
                    ...
                    <button
                        onClick={onSave}
                        className="px-4 py-2 text-sm font-medium text-white bg-greenTheme hover:bg-green-600 rounded-lg"
                    >
                        Save Changes
                    </button>
